...
//go:generate go run ../_tools/tmpl/main.go -i -data=uint64.tmpldata type.go.tmpl=uint64.go type_test.go.tmpl=uint64_test.go
//go:generate go run ../_tools/tmpl/main.go -i -data=uint64.tmpldata -d arch=avx2 type_amd64.go.tmpl=uint64_avx2_amd64.go
//go:generate go run ../_tools/tmpl/main.go -i -data=uint64.tmpldata -d arch=sse4 type_amd64.go.tmpl=uint64_sse4_amd64.go
